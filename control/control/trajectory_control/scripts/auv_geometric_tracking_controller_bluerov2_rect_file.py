...
class AUVGeometricTrackingControllerBluerov2RectFile:
    def __init__(self):
        ...
        # Reading the thruster topic
        self.thruster_topic_1 = rospy.get_param('~thruster_topic_0', 'thrusters/1/input')
        assert len(self.thruster_topic_1) > 0

        # Reading the thruster topic
        self.thruster_topic_2 = rospy.get_param('~thruster_topic_0', 'thrusters/2/input')
        assert len(self.thruster_topic_2) > 0

        # Reading the thruster topic
        self.thruster_topic_3 = rospy.get_param('~thruster_topic_0', 'thrusters/3/input')
        assert len(self.thruster_topic_3) > 0

        # Reading the thruster topic
        self.thruster_topic_4 = rospy.get_param('~thruster_topic_0', 'thrusters/4/input')
        assert len(self.thruster_topic_4) > 0

        # Reading the thruster topic
        self.thruster_topic_5 = rospy.get_param('~thruster_topic_0', 'thrusters/5/input')
...
# Truster 1 --------------------------------------------------------------------------------------------------------
        ...
        frame_1 = '%s/%s%d' % (self.namespace, self.thruster_config['frame_base'], 1)
...
# Truster 2 --------------------------------------------------------------------------------------------------------
        ...
        frame_2 = '%s/%s%d' % (self.namespace, self.thruster_config['frame_base'], 2)
...
# Truster 3 --------------------------------------------------------------------------------------------------------
        ...
        frame_3 = '%s/%s%d' % (self.namespace, self.thruster_config['frame_base'], 3)
...
if __name__ == '__main__':
    ...
    rospy.init_node('auv_geometric_tracking_controller_bluerov2_rect_file')

    try:
        node = AUVGeometricTrackingControllerBluerov2RectFile()
        rospy.spin()
