...
#include <sensor_ros_plugins_msgs/ChangeSensorState.h>
...
namespace gazebo
{
  class ROSBasePlugin
  {
    ...
    protected: bool ChangeSensorState(
        sensor_ros_plugins_msgs::ChangeSensorState::Request& _req,
        sensor_ros_plugins_msgs::ChangeSensorState::Response& _res);
