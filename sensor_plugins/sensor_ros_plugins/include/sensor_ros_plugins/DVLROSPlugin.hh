...
#ifndef __DVL_ROS_PLUGIN_HH__
#define __DVL_ROS_PLUGIN_HH__
...
#include <sensor_ros_plugins_msgs/DVL.h>
#include <sensor_ros_plugins_msgs/DVLBeam.h>
...
namespace gazebo
{
  ...
  class DVLROSPlugin : public ROSBaseModelPlugin
  {
    ...
    protected: sensor_ros_plugins_msgs::DVL dvlROSMsg;

    protected: std::vector<sensor_ros_plugins_msgs::DVLBeam> dvlBeamMsgs;
